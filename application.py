...
>>>>>>> 4e1f5e27385a2fb77529e4ca38812a010aa21670
...
|_|                       |___/                     
           ...
           |___/_| |_|_| .__/|___/ (_|_|_)          
                       |_|                          """
<<<<<<< HEAD
    print "Player 1 puts your ships"
def place_your_2():
    print """
=======
                    print_board(BOARD_U)
...
|_|                       |___/                     
           ...
           |___/_| |_|_| .__/|___/ (_|_|_)          
                       |_|                          """
<<<<<<< HEAD
    print "Player 2 puts your ships"
...
def boat_user_2():
    """Place the user boats  :::"""
    print"asdkfjdfjadskljdfkljdasf"
    place_user()
    for_def(BOARD_U)
    for boat in SHIPS:
        repeat = False
...
def hit_player_1(board, boat):
    print "Dispara... "
    print "este es el primer usuario"
    guess_row=  enter_row()
    guess_col= enter_col()
    raw_input("\nDisparar...")
    DISPAROS.play()
    ...
    for coor in range(1):
        ...
        statistics_other(BOARD_PLAYER_1)
        raw_input("\npress enter to place ...")
        clean()
...
def hit_player_2(board, boat):
    print "este es el segundo jugador"
    guess_row = random_row()
=======
def hit_user_2(board, boat):
        guess_row = random_row()
>>>>>>> 4e1f5e27385a2fb77529e4ca38812a010aa21670
...
<<<<<<< HEAD
            BOARD_U_2[guess_row][guess_col] = "| X "
=======
>>>>>>> 4e1f5e27385a2fb77529e4ca38812a010aa21670
            ACIERTO.play()
...
\/    |_|\__,_|\__, |  \__,_|\__, |\__,_|_|_| |_| (_|_|_)   
    ...
    reply = raw_input("You want to do?...")
    if reply == "1":
        name_user()
    elif reply == "2":
        menu()
...
def statistics_other(BOARD_PLAYER_1):
    count = 0
    aircraft = 0
    battleship = 0
    destroyer = 0
